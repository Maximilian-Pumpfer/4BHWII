...
client.username_pw_set("Stingaaa", "Satch01#")
...
def play(name):
    print(name)
    client.loop_start()
    client.publish("encyclopedia/temperature", payload=name, qos=1)
    client.loop_stop()
    mixer.init()
...
def stop():
    client.loop_start()
    client.publish("encyclopedia/temperature", payload="stop", qos=1)
    time.sleep(10)
    client.loop_stop()
    mixer.music.stop()
    return render_template("play.html")
...
def pause():
    client.loop_start()
    client.publish("encyclopedia/temperature", payload="pause", qos=1)
    client.loop_stop()
    mixer.music.pause()
    return render_template("play.html")
...
def unpause():
    client.loop_start()
    client.publish("encyclopedia/temperature", payload="unpause", qos=1)
    client.loop_stop()
    mixer.music.unpause()
    return render_template("play.html")  
